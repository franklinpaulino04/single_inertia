...
import {useLayoutComposable} from "@/Composables/useLayoutComposable.js";


const { layoutConfig, setPrimary, setSurface, setPreset, isDarkTheme, setMenuMode } = useLayoutComposable();
